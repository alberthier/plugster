...
{
    public static const double base_margin = 5.0; // TODO: get this from the theme
    public static const double double_margin = 2.0 * base_margin;
    public static const double quad_margin = 2.0 * double_margin;
